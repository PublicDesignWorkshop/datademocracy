...
define('CONSUMER_KEY', 'oQIyeuFHRSVt2vA6OPvXDQYWV');
define('CONSUMER_SECRET', 'VgwltbHv5I8rfhNkTYRgrf9ZvZW9mITsvUhIyFD2vQsq2EousO');
/**
...
*/
function search_for_a_term($bearer_token, $query, $result_type='mixed', $count='20'){
	$url = "https://api.twitter.com/1.1/search/tweets.json"; // base url
	$q = (trim($query)); // query term
...
function search_for_a_tweet($bearer_token, $id){
	$url = "https://api.twitter.com/1.1/statuses/show.json"; // base url
	$formed_url ='?id='.$id; // fully formed url
	$formed_url = $formed_url.'&include_entities=true'; // makes sure the entities are included, note @mentions are not included see documentation
	$headers = array( 
